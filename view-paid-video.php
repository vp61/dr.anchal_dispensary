                  ...
                  <table id="dataTableExample" class="table">
                    ...
                    <tbody>
                              ...
                              if(isset($_GET['delete'])){
                                ...
                                mysqli_query($con, "DELETE FROM `paidvideo` where id='$cid1'");
                              }
                                      ...
                                      $sql1 = mysqli_query($con, "SELECT * FROM `paidvideo`");
                      ...
                      <tr>
                        ...
                        <td><a target="_blank" href="vimoplay.php?videoid=<?php echo $row['videoid'] ;?> "><img src="api/<?php  echo $row['thumbnail']  ?>"  ></a> </td>
                        <td><a target="_blank" href="vimoplay.php?videoid=<?php echo $row['videoid'] ;?> "><img src="api/<?php  echo $row['thumbnail']  ?>"  ></a> </td>
                      
                        <td><a class="font-12" href="add-paid-video.php?edit=<?php echo $row['id'] ;?>"><i data-feather="edit"></i> </a>  <a class="font-12" href="?delete=<?php echo $row['id'] ;?>"><i data-feather="archive"></i> </a> </td>
                      </tr>

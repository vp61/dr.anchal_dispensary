  ...
  ?>
		...
		<div class="page-wrapper">
			...
			<div class="page-content">
				...
				<div class="row">
				<div class="col-md-12 text-right mb-3"><a class="btn btn-success" href="add-quiz.php"><i data-feather="plus"></i> Add Question</a></div>
				</div>
            ...
            <div class="card">
              <div class="card-body">
                <h6 class="card-title">View Question</h6>
...
$sql1 = mysqli_query($con, "SELECT * FROM `question`");
...
?>
                      ...
                      <tr>
                        ...
                        <td><a class="font-12" data-toggle="modal" data-target="#exampleModal<?php  echo $row['ids']  ?>"><i data-feather="eye"></i> </a>  <a class="font-12" href="?delete=<?php echo $row['ids'] ?>"><i data-feather="archive"></i> </a></td>
                      </tr>
...
?>
		...
		<p>(<?php echo $i ?>)  <?php  echo $ro['answer'];  if($ro['correct']==1){ echo "<strong style='color:green'>      - Right Answer</strong>"; } ?>      </p>

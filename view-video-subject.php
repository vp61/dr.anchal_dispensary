...
include "header.php";
  ?>
      ...
      <div class="page-content">
				...
				<div class="row">
				<div class="col-md-12 text-right mb-3"><a class="btn btn-success" href="addvideocourse.php"><i data-feather="plus"></i> Add Subject</a></div>
				</div>
                  ...
                  <table id="dataTableExample" class="table">
                    ...
                    <tbody>
                                                      ...
                                                      if(isset($_GET['delete'])){
                                                        ...
                                                        mysqli_query($con, "DELETE FROM `corce` where id='$cid1'");
                                                      }
                                                      ...
                                                      $sql1 = mysqli_query($con, "SELECT * FROM `corce`");
                      ...
                      <tr>
                        ...
                        <td><img src="api/<?php  echo $row['thumbnail']  ?>"  ></td>
                      
                        <td><a class="font-12" href="addvideocourse.php?edit=<?php echo $row['id'] ;?>"><i data-feather="edit"></i> </a>  <a class="font-12" href="?delete=<?php echo $row['id'] ;?>"><i data-feather="archive"></i> </a> </td>
                      </tr>

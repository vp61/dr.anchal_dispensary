  ...
  ?>
        ...
        <div class="page-wrapper">
            ...
            <div class="page-content">
                ...
                <!-- <div class="row">
                    <div class="col-md-12 text-right mb-3"><a class="btn btn-success" href="api/register.php"><i
                                data-feather="plus"></i>add Users</a></div>
                </div> -->
                                ...
                                <div class="table-responsive">
                                    <table id="dataTableExample" class="table">
                                        ...
                                        <?php
                                                      ...
                                                      $sql1 = mysqli_query($con, "SELECT * FROM `registeration` ");
                                            ...
                                            <td><?php  echo $row['id']  ?></td>
                                                ...
                                                <td><?php  echo $row['wmobile']  ?></td>
                                                <td><?php  echo $row['gender']  ?></td>
                                                <td><?php  echo $row['dentalcollege']  ?></td>
                                                <td><?php  echo $row['checkstudant']  ?></td>
                                                <td><?php  echo $row['creentbatch']  ?></td>
